...
class TeacherInfoXadmin(object):
    list_display = ['name', 'image', 'work_year', 'work_company', 'click_num', 'work_position', 'age','work_style','orginfo', 'add_time']
    search_fields = ['name', 'image', 'work_year', 'work_company', 'click_num', 'work_position', 'age','work_style','orginfo', 'add_time']
    list_filter = ['name', 'image', 'work_year', 'work_company', 'click_num', 'work_position', 'age','work_style','orginfo', 'add_time']
